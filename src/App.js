...
import { Userlist, ContentsList, AgreeTerms, Privacy, Ncs, ContentsDetail, Psat, Notice, UserDetail, BbsDetail, Bbs } from './pages';
  ...
  return (
    ...
    <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/bbs/notice/:id" element={<BbsDetail />} />
